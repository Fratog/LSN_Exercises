...
vector<double> blocking(vector <double> ist, int Nblocks, int Nstep_x_block) //it expexts the vector of instant values
{
...
vector<double> running_err(vector <double> A) //riporta quella di block method
{
